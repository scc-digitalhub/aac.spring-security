...
public class DelegatePermissionEvaluator implements PermissionEvaluator {

    private final static Logger _log = LoggerFactory.getLogger(DelegatePermissionEvaluator.class);
    ...
    public DelegatePermissionEvaluator(NamedPermissionEvaluator... evaluators) {
